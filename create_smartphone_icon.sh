...
# スマートフォン型の電話アイコン付きPWAアイコン作成

echo "🎨 スマートフォン型電話アイコン版PWAアイコン作成開始..."
...
convert -size 192x192 xc:"${BG_COLOR}" \
    ...
    -draw "roundrectangle 76,30 116,80 8,8" \
    -draw "circle 96,68 96,72" \
...
convert -size 512x512 xc:"${BG_COLOR}" \
    ...
    -draw "roundrectangle 202,80 310,214 20,20" \
    -draw "circle 256,182 256,192" \
...
echo "✅ スマートフォン型電話アイコン版PWAアイコン作成完了！"
