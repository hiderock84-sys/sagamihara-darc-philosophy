...
INSERT INTO response_phrases (category, phase, situation, phrase_type, phrase_text, sort_order) VALUES
  ...
  -- 匿名性の保証
  ('opening', '第1段階', '匿名性の保証', 'OK例', 'お名前は伏せていただいても構いません。まずはお話をお聞かせください。', 2),
  
  -- 相談者の状態確認
  ('opening', '第1段階', '相談者の状態確認', 'OK例', '今、お話できる状況でしょうか？落ち着いてお話しいただける環境ですか？', 3),
  
  -- 緊急度確認
  ('opening', '第1段階', '緊急度確認', 'OK例', 'まず確認させてください。今すぐ助けが必要な状況でしょうか？', 4),
  
  -- 家族からの電話
  ('opening', '第1段階', '家族からの相談', 'OK例', '相模原ダルクの〇〇です。ご家族の方からのご相談ですね。お話をお聞かせください。', 5),
  
  -- 緊張している相手への配慮
  ('opening', '第1段階', '緊張への配慮', 'OK例', '相模原ダルクの〇〇と申します。電話するのは勇気がいったと思います。ゆっくりで大丈夫ですので、お話しくださいね。', 6);
